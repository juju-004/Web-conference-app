        ...
        <section className="bg-gray-950 text-white">
          <div className="mx-auto max-w-screen-xl px-4 py-32 flex-col gap-24 flex h-screen items-center">
            <div className="flex items-center w-full justify-around">
              ...
              <span className="bg-purple-600/20 ml-3 rounded-3xl flex items-center py-1.5 pl-2 pr-3">
                <span className="rounded-full w-6 h-6 text-xs flex items-center font-bold justify-center mr-1 bg-purple-600">
                  {user.slice(0, 1)}
                </span>
                <span>{user}</span>
              </span>
